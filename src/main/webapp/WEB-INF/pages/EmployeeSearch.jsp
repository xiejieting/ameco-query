        ...
        <div class="admin-content">
            ...
            <div class="am-g">
                <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
                    <form:form class="am-form" method="POST" commandName="employee"
                               action="${pageContext.request.contextPath}/employee.do?method=search">
                        <div class="am-form-group am-form-icon">
                            <i class="am-icon-user"></i>
                            <form:input type="text" class="am-form-field" path="employee_name" placeholder="姓名 Name"
                                        size="30"/>
                        </div>
                        <div class="am-form-group am-form-icon">
                            <i class="am-icon-info"></i>
                            <form:input type="text" class="am-form-field" path="employee_id"
                                        placeholder="职工编号 Employee ID"/>
                        </div>
                        <div class="am-form-group am-form-icon">
                            <i class="am-icon-sort-alpha-desc"></i>
                            <form:input type="text" class="am-form-field" path="employee_spell" placeholder="全拼 Spell"/>
                        </div>
                        <div class="am-form-group am-form-icon">
                            <i class="am-icon-building"></i>
                            <form:input type="text" class="am-form-field" path="employee_department"
                                        placeholder="部门 department"/>
                        </div>
                        <div class="am-form-group am-form-icon">
                            <i class="am-icon-building"></i>
                            <form:input type="text" class="am-form-field" path="employee_mobile"
